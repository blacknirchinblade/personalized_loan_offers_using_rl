...
if use_gpu:
    default_model = XGBClassifier(tree_method='gpu_hist', n_estimators=100, learning_rate=0.1, max_depth=3, random_state=42, n_iter_no_change=5, validation_fraction=0.1)
else:
